...
// Needed to calculate correct paths (backend/projects)
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

// This resolves to backend/projects (outside src)
...
export const handleContainerCreate = async (
  ...
  try {
    ...
    // Absolute path to the actual project directory
    ...
    const container = await docker.createContainer({
      ...
      HostConfig: {
        Binds: [
          ...
          `${projectPath}:/home/sandbox/app`,
        ],
        PortBindings: {
          "5173/tcp": [
            {
              HostPort: "0", // random port assigned by docker
            },
          ],
        },
      },
